...
import Search from './uiTools/auth-info/Search';
import AuthInfo from './uiTools/auth-info/info';
              ...
              <div className="flex flex-row items-center flex-1 h-full">
                <div className=" rtl:ssm:pr-[15px] ltr:pr-5 rtl:pl-5 ltr:ssm:pl-[15px] ltr:ssm:pr-[15px] rtl:ssm::pl:[15px] ltr:pl-[30px] rtl:pr-[30px] xs:ltr:pl-[20px] xs:rtl:pr-[20px] min-w-[280px] ssm:min-w-[220px] xs:min-w-[170px] h-full grid align-middle dark:bg-[#323541]">
                  <div className="flex items-center justify-between">
                    <Link to="/">
                      <img
                        className="w-full max-w-[160px] xs:max-w-[140px]"
                        src={
                          layoutMode === 'lightMode'
                            ? require(`../static/img/FullLogoLight.svg`).default
                            : require(`../static/img/FullLogoDark.svg`).default
                        }
                        alt=""
                      />
                    </Link>
            ...
            <Layout>
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <FooterStyle className="bg-dark dark:bg-[#1B1E2B]">
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="inline-block w-full font-medium admin-footer__copyright md:text-center text-white60 dark:text-white60 md:mb-[10px]">
                          © 2023
