    ...
    <div className="flex items-center ltr:mr-2.5 rtl:ml-2.5">
      ...
      <Link
        ...
        className={
          openSearch
            ? 'hidden opacity-0'
            : 'hexadash-search-icon flex relative -top-1 w-5 h-5 text-theme-gray dark:text-white60 '
        }
      >
        <UilSearch />
      </Link>
      <Link
        ...
        className={openSearch ? 'flex relative -top-1 w-5 h-5 text-theme-gray dark:text-white60' : 'hidden opacity-0'}
      >
        <UilTimes />
      </Link>
    </div>
