...
const AutoComplete = React.memo((props) => {
  ...
  return customComponent ? (
    ...
    >
      <Input
        className="bg-dark text:white px-5 border border-regular dark:border-white10 shadow-none rounded-[100px] [&>input]:!bg-transparent dark:[&>input]:!bg-transparent h-[38px]"
        suffix={
          patternButtons ? (
            <Button
