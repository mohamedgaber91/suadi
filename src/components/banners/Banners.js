...
function Banner9(props) {
  return (
    <div className='relative bg-gradient-to-tr from-[#5840ff] via-[#0082ff] to-[#00caff]  rounded-[10px]'>
      <div className="bg-center bg-cover relative min-h-[350px] pt-10 px-[30px] pb-[70px]  bg-[url('static/img/banner/club1.png')]">
        <div className="bg-blue-50/70	 dark:bg-zinc-900/70 w-100 text-center m-100 p-10 ">
          {props.data ?
            <div>
              <h1 className='text-2xl'>Club Info</h1>
              <h1 className='font-semibold'>Name: {props.data.clubName.ar} | {props.data.clubName.en}</h1>
              <h1 className='font-semibold'>Establish Date: {props.data.establishDate} </h1>
            </div>
            : <h1 className='text-2xl'>Match Info</h1>}
        </div>
      </div></div>
  );
}
...
function BannerCarousel() {
  return (
    <BannerCardStyleWrap>
      <div className="relative  mb-8  rounded-10">
        <Carousel autoplay>
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-max ">
              <img className="w-screen max-h-screen max-h-[550px]" src={require('../../static/img/banner/1.jpg')} alt="" />
            </div>
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-full">
              <img className="w-screen max-h-screen max-h-[550px]" src={require('../../static/img/banner/3.jpg')} alt="" />
            </div>
            <div className="text-center mt-7">
