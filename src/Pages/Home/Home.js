...
function Home(props) {
    ...
    return (
        <>
            ...
            <RightImg
                rightSrc={img} alt='business' title='welcome to' haveLogo={true} text={<Logo />}
                haveButtons={true} className='home' imgClassName='homeImg' colImg='6' colText='6'
                divTextClassName='homeText' darkMode={darkMode}
            />
            <LeftImg
                leftSrc={<Logo />} alt='logo' title='Welcome to'
                ...
                darkMode={darkMode} className='welcome' imgClassName='welcomeImg' colImg='6' colText='6' haveLogo={true}
            ...
            <LeftImg
                ...
                className='comp welcome ' alt='logo' title='BCG'
                text='BCG is a global consulting firm that partners with leaders in business and society
                 ...
                 darkMode={darkMode} divImgClassName='companiesImg' colImg='12' colText='12' haveLogo={true} divTextClassName='bcg'
                secIs={true} headSec={<h2 className="text-start">Companies </h2>} />
            <LeftImg
                leftSrc={
                    <>
                        <img src={comp1} alt="..." />
                ...
                className='comp Indiv ' alt='logo' title='BCG'
                text='BCG is a global consulting firm that partners with leaders in business and society
                 to tackle their most important challenges. Learn more about BCG'
                 darkMode={!darkMode} divImgClassName='companiesImg' colImg='12' colText='12' haveLogo={true} divTextClassName='bcg'
                secIs={true} headSec={<h2 className="text-start">Individuals </h2>} />
        </>
    );
}
